                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <c:if test="${ imagemUser == '' || imagemUser == null }">
                                  <img class="img-80 img-radius" src="<%= request.getContextPath() %>/assets/images/avatar555.png" alt="User-Profile-Image">
                                  </c:if>
                         ...
                         <!--   <div class="pcoded-navigation-label" data-i18n="nav.category.navigation">Layout</div> -->
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="active">
                                  <a href="<%=request.getContextPath() %>/principal/principal.jsp" class="waves-effect waves-dark" style="margin-top: 10px">
                                      ...
                                      <span class="pcoded-mtext" data-i18n="nav.dash.main">In&iacute;cio</span>
                                  ...
                                  <c:if test="${perfil == 'ADMIN'}">
                                      <li class=" ">
                                          <a href="<%=request.getContextPath() %>/ServletUsuarioController?acao=ListarUser" class="waves-effect waves-dark">
                                              ...
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Usu&aacute;rio</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      </c:if>
                          ...
                          <!--  
                          <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Relat&oacute;rio</div>
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="form-elements-component.html" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Usu&aacute;rio</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              ...
                              <li class="pcoded-hasmenu">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Relat&oacute;rio</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                      ...
                                      <li class=" ">
                                          <a href="<%=request.getContextPath() %>/principal/relusergrafico.jsp" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Gr&aacute;fico sal&aacute;rio</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                               </ul>
