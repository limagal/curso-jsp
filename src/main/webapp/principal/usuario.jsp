                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Cad. Usu&aacute;rio</h4>
		                                              
          												 <form class="form-material" enctype="multipart/form-data" action="<%= request.getContextPath() %>/ServletUsuarioController" method="post" id="formUser" name="formUser">
                                                            ...
                                                            <div class="form-group form-default input-group mb-4">
                                                            	...
                                                            	<c:if test="${modolLogin.fotouser == '' || modolLogin.fotouser == null}" >
                                                            		<img alt="Image User" id="fotoembase64" src="assets/images/avatar555.png" width="70px">
                                                            	</c:if>
                                                            	</div>
                                                            		<input type="file" id="fileFoto" name="fileFoto" accept="image/*" onchange="vizualizaImg('fotoembase64', 'fileFoto');" class="form-control-file" style="margin-top: 15px mar; margin-left: 5px; ">
															...
															<select class="form-control" aria-label="Default select example" name="perfil">
																<option disabled="disabled" selected>Selecione o perfil</option>
										...
										<div style="height: 300px; overflow: scroll;">
											<table class="table" id="tabelaresultadosview">
												...
												<td><a class="btn btn-danger" href="javascript:del(${ml.id});">Excluir</a></td>
												</tr>
...
function del(id) {  
    if (confirm('Excluir registro?')) {  
        location.href = '<%=request.getContextPath()%>/ServletUsuarioController?acao=deletar&id=' + id;
    }
}
		 ...
		 $("#ulPaginacaoUserAjax > li").remove();
		  ...
		  for(var p = 0; p < totalPagina; p++){
	         ...
	         var url = 'nomeBusca=' + nomeBusca + '&acao=buscarUserAjaxPage&pagina='+ (p * 5);
			  ...
			  //$("#ulPaginacaoUserAjax").append('<li class="page-item"><a class="page-link" onclick=buscarUserPagAjax('+url+')>'+(p + 1)+'</a></li>');
