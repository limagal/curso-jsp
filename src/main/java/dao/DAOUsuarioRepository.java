...
public class DAOUsuarioRepository {
	...
	public DAOUsuarioRepository() {
     ...
     public BeanDtoGraficoSalarioUser montarGraficoMediaSalario (Long userLogado, String dataInicial, String dataFinal) throws Exception {
 		...
 		preStatement.setLong(1, userLogado);
 		preStatement.setDate(2, Date.valueOf(new SimpleDateFormat("yyyy-mm-dd").format(new SimpleDateFormat("dd/mm/yyyy").parse(dataInicial))));
		preStatement.setDate(3, Date.valueOf(new SimpleDateFormat("yyyy-mm-dd").format(new SimpleDateFormat("dd/mm/yyyy").parse(dataFinal))));
	...
	public ModelLogin consultaUsuarioLogado(String login) throws Exception {
		...
		String sql = "select * from model_login where upper(login) = upper('" + login + "') limit 5";
	...
	public List<ModelTelefone> listFone(Long idUserPai) throws Exception {
		...
		while (rs.next()) {
			...
			modelTelefone.setUsuario_pai_fk(this.consultaUsuarioID(rs.getLong("usuario_pai_id")));
			modelTelefone.setUsuario_cad_fk(this.consultaUsuarioID(rs.getLong("usuario_cad_id")));
