		...
		try {
			...
			if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
				...
				List<ModelLogin> modelLogins = daoUsuarioRepository
						.consultaUsuarioListPaginado(this.getUserLogado(request), offset);
				...
				request.getRequestDispatcher("principal/reluser.jsp").forward(request, response);
					...
					|| acao.equals("imprimirRelatorioExcel")) {
				...
				if (acao.equalsIgnoreCase("imprimirRelatorioPDF")) {
					...
					relatorio = new ReportUtil().geraRelatorioPDF(modelLogins, "relatori_jsp", params,
							request.getServletContext());
					extensao = ".pdf";

				} else if (acao.equalsIgnoreCase("imprimirRelatorioExcel")) {

					relatorio = new ReportUtil().geraRelatorioExcel(modelLogins, "relatori_jsp", params,
							request.getServletContext());
					extensao = ".xls";
				}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (daoUsuarioRepository.validarLogin(modelLogin.getLogin()) && modelLogin.getId() == null) {
				msg = "J&aacute; existe usuario com o mesmo login, informe outro login;";
			} else {
