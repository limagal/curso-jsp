	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!daoTelefoneRepository.existeFone(numero, Long.valueOf(usuario_pai_id))) {
				...
				modelTelefone.setUsuario_pai_fk(daoUsuarioRepository.consultaUsuarioID(Long.parseLong(usuario_pai_id)));
				modelTelefone.setUsuario_cad_fk(super.getUserLogadoObject(request));
